    ...
    <section id="services">
        ...
        <div class="container">
			...
			?>
					...
					<div class="col-lg-3 col-md-6 text-center"><a href="<?echo $name?>.php">
						<div class="service-box">
							<i class="fa fa-4x text-primary sr-icons"><img src="img/allDeviceCategories/<?echo $icon ?>.png" style="width:150px;height:150px;"/></i>
							<h3><?echo $name;?></h3>
			...
			?>		
					<div class="col-lg-3 col-md-6 text-center"><a href="promoDevices.php">
						<div class="service-box">
							<i class="fa fa-4x text-primary sr-icons"><img src="img/allDeviceCategories/discount.png" style="width:150px;height:150px;"/></i>
							<h3>Promo Devices</h3>
